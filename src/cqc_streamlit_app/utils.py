...
def define_chatGPTModel(unique_key: str | int, default_min_value: float = .2, default_max_value: float = .8,
                        ...
                        default_step: float = 0.1, default_option="gpt-3.5-turbo") -> Tuple[str, float]:
    # Dropdown for selecting ChatGPT models
    model_options = [default_option, "gpt-3.5-turbo-16k-0613", "gpt-4o", "gpt-4-turbo", "gpt-4-1106-preview"]
