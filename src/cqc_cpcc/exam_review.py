...
class ErrorDefinitions(ErrorHolder):
    ...
    """
    all_minor_errors: Optional[
        Annotated[
            List[MinorError],
            Field(description="List of all the minor code errors.")
        ]
    ] = None

    all_major_errors: Optional[
        Annotated[
            List[MajorError],
            Field(description="List of all the major code errors.")
        ]
    ] = None
    """
